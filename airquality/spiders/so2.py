...
class AirqualityontarioSpider(scrapy.Spider):
    ...
    # CO, PM2.5, NO2, 03, SO2
    start_urls = ["http://www.airqualityontario.com/history/searchResults.php?page=_search&s_categoryId=Academic&s_stationId=51002,51001&s_pollutantId=9&s_startDate=01/01/2021&s_endDate=12/31/2021&s_reportType=HTML"]
