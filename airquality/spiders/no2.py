...
class AirqualityontarioSpider(scrapy.Spider):
    ...
    # CO, PM2.5, NO2, 03, SO2
    start_urls = ["http://www.airqualityontario.com/history/searchResults.php?page=_search&s_categoryId=Academic&s_stationId=51002,51001&s_pollutantId=36&s_startDate=01/01/2021&s_endDate=12/31/2021&s_reportType=HTML"]
    ...
    def parse_url(self, response):
        ...
        for row in rows:
            ...
            for i in td_list:
                no2 = row.xpath(".//td[" + str(i) + "]/text()").get()
